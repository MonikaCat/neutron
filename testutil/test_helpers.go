...
import (
	...
	ictxstypes "github.com/MonikaCat/neutron/v2/x/interchaintxs/types"
...
func (suite *IBCConnectionTestSuite) StoreTestCode(ctx sdk.Context, addr sdk.AccAddress, path string) uint64 {
	// wasm file built with https://github.com/MonikaCat/neutron/v2-contracts/tree/main/contracts/reflect
	// wasm file built with https://github.com/MonikaCat/neutron/v2-dev/tree/feat/ica-register-fee-update/contracts/neutron_interchain_txs
